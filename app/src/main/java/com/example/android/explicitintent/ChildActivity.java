...
public class ChildActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent startIntentThisActivity=getIntent();
        if (startIntentThisActivity.hasExtra(Intent.EXTRA_TEXT)){
            String textEntered=startIntentThisActivity.getStringExtra(Intent.EXTRA_TEXT);
